        ...
        .then(result => {
            if (result.success && result.usuario) {
                ...
                sessionStorage.setItem('usuario_logueado', JSON.stringify({
                    ...
                    rol: result.roles && result.roles.length > 0 ? result.roles[0].nombre : 'Inventario'
                }));
...
async function inicializarMenu() {
    ...
    try {
        ...
        // Verificar que el usuario tenga rol de inventario
        const rol = usuario.rol ? usuario.rol.toLowerCase() : '';
        if (rol !== 'inventario') {
            window.location.href = getBaseUrl();
            return;
...
function cambiarContenido(opcion) {
    ...
    switch(opcion) {
        case 'Inicio':
            container.innerHTML = `
                <div class="welcome-card">
                    ...
                    <p>Gestiona Espacios e Inventario del Sistema</p>
                </div>
                ...
                <div class="dashboard-cards-container">
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="dashboard-card-body">
                            ...
                            <div class="dashboard-stat">
                                ...
                                <span class="stat-value" id="stat-items-activos">-</span>
                            </div>
                            <div class="dashboard-stat">
                                <span class="stat-label">Items de Baja</span>
                                <span class="stat-value" id="stat-items-baja">-</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card">
                        ...
                        <div class="dashboard-card-body">
                            <div class="dashboard-stat">
                                <span class="stat-label">Total de Cambios Realizados</span>
                                <span class="stat-value" id="stat-total-cambios">-</span>
                            </div>
                            <div class="dashboard-stat">
            ...
            `;
            setTimeout(() => {
                cargarEstadisticasDashboardInventario();
            }, 100);
            break;
        ...
        case 'Registrar Espacios':
            container.innerHTML = `
                <div class="welcome-card">
                    ...
                    <div class="geometric-rect-10"></div>
                    <div class="geometric-triangle-10"></div>
                    <h2>Registrar Espacios</h2>
                    <p>Registra nuevos espacios en el sistema</p>
                </div>
                
                <!-- Formulario de Registro de Espacios -->
                <div class="form-container">
                    <form id="formRegistrarEspacio" class="register-space-form" onsubmit="registrarEspacio(event)">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="nombre_oficina">Nombre de la Oficina o Seccion *</label>
                                    <input type="text" id="nombre_oficina" name="nombre_oficina" required placeholder="Ej: Oficina de Recursos Humanos">
                                </div>
                                <div class="form-group">
                                    <label for="edificio_oficina">Edificio</label>
                                    <input type="text" id="edificio_oficina" name="edificio_oficina" placeholder="Ej: Edificio Central">
                                </div>
                            </div>
                            
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="piso_oficina">Piso</label>
                                    <input type="number" id="piso_oficina" name="piso_oficina" placeholder="Ej: 3" min="0">
                                </div>
                                <div class="form-group">
                                    <label for="ubicacion_fisica">Ubicación Física</label>
                                    <input type="text" id="ubicacion_fisica" name="ubicacion_fisica" placeholder="Ej: Ala Norte, Segundo Piso">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <select id="id_direccion" name="id_direccion" onchange="cargarDepartamentos()">
                                        <option value="">Ninguna - Oficina o Seccion independiente</option>
                                        <option value="__crear_nuevo__">➕ Crear Nueva Dirección</option>
                                    </select>
                                    <input type="text" id="nueva_direccion_nombre" name="nueva_direccion_nombre" placeholder="Nombre de la nueva dirección" style="display: none; margin-top: 8px;" class="nuevo-campo-input">
                                </div>
                                <div class="form-group">
                                    <label for="id_departamento">Departamento (Opcional)</label>
                                    <select id="id_departamento" name="id_departamento" onchange="cargarSecciones()">
                                        <option value="">Ninguno - Solo Dirección</option>
                                        <option value="__crear_nuevo__">➕ Crear Nuevo Departamento</option>
                                    </select>
                                    <input type="text" id="nuevo_departamento_nombre" name="nuevo_departamento_nombre" placeholder="Nombre del nuevo departamento" style="display: none; margin-top: 8px;" class="nuevo-campo-input">
                                </div>
                            </div>
                            
                            <div class="form-row" style="grid-template-columns: 1fr;">
                                <div class="form-group">
                                    <label for="id_seccion">Sección (Opcional)</label>
                                    <select id="id_seccion" name="id_seccion">
                                        <option value="">Ninguna - Solo Departamento</option>
                                        <option value="__crear_nuevo__">➕ Crear Nueva Sección</option>
                                    </select>
                                    <input type="text" id="nueva_seccion_nombre" name="nueva_seccion_nombre" placeholder="Nombre de la nueva sección" style="display: none; margin-top: 8px;" class="nuevo-campo-input">
                                </div>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    <label for="id_usuario_asignacion">Usuario</label>
                                    <select id="id_usuario_asignacion" name="id_usuario_asignacion">
                        ...
                        <div class="form-section">
                            <div class="section-header">
                                ...
                                <button type="button" class="btn-add-item" onclick="agregarItemInventario()">
                                    <i class="fas fa-plus"></i> Agregar Item
                                </button>
                            </div>
                            <div class="section-body">
                            <div id="inventario-items" class="inventario-items">
                        ...
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-submit">
                                <i class="fas fa-save"></i> Registrar Espacio
                            </button>
                        </div>
                    </form>
                </div>
        ...
        case 'Gestionar Espacios':
                    ...
                    <div class="filtro-body">
                        <div class="filtro-row">
                            <div class="filtro-group">
                                ...
                                <select id="filtro_direccion" onchange="aplicarFiltros()">
                                    <option value="">Todas las direcciones</option>
                                </select>
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-sitemap"></i> Departamento</label>
                                <select id="filtro_departamento" onchange="aplicarFiltros()">
                                    <option value="">Todos los departamentos</option>
                                </select>
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-folder"></i> Sección</label>
                                <select id="filtro_seccion" onchange="aplicarFiltros()">
                        ...
                        <div class="filtro-row">
                            <div class="filtro-group">
                                <label><i class="fas fa-building"></i> Oficina o Seccion</label>
                                <input type="text" id="filtro_oficina" placeholder="Buscar por nombre de oficina o seccion..." onkeyup="aplicarFiltros()">
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-user"></i> Usuario Asignado</label>
                                <select id="filtro_usuario" onchange="aplicarFiltros()">
                                    <option value="">Todos los usuarios</option>
                                </select>
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-layer-group"></i> Piso</label>
                                <input type="text" id="filtro_piso" placeholder="Buscar por piso..." onkeyup="aplicarFiltros()">
                            </div>
                        </div>
                        <div class="filtro-row">
                            <div class="filtro-group filtro-full">
                                <label><i class="fas fa-map-marker-alt"></i> Ubicación Física</label>
                                <input type="text" id="filtro_ubicacion" placeholder="Buscar por ubicación física..." onkeyup="aplicarFiltros()">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="spaces-card">
                        <div class="card-header">
                            <div class="header-content">
                                ...
                                <button class="btn-refresh" onclick="cargarEspacios(paginaActual)" title="Actualizar lista">
                            ...
                            <div id="espacios-table-container" style="display: none;">
                                ...
                                <div id="espacios-paginacion" class="paginacion-container" style="display: none;">
                                    ...
                                    <div class="paginacion-controls">
                                        <button id="btn-pagina-anterior" class="btn-pagina" onclick="cambiarPagina(-1)" disabled>
                                            <i class="fas fa-chevron-left"></i> Anterior
                                        </button>
                                        <div class="paginacion-numeros" id="paginacion-numeros">
                                            <!-- Los números de página se generarán aquí -->
                                        </div>
                                        <button id="btn-pagina-siguiente" class="btn-pagina" onclick="cambiarPagina(1)" disabled>
                            ...
                            <div id="modal-editar-espacio" class="modal-detalle-overlay" style="display: none;">
                                <div class="modal-editar-content">
                                    <div class="modal-detalle-header">
                                        ...
                                        <button class="modal-detalle-close" onclick="cerrarModalEditar()">
                                            <i class="fas fa-times"></i>
                                        </button>
                                    </div>
            ...
            setTimeout(() => {
                cargarFiltros();
                cargarEspacios(1); // Empezar en la primera página
            }, 200);
            break;
        ...
        case 'Inventario':
            container.innerHTML = `
                ...
                <div class="filtro-busqueda-container">
                    <div class="filtro-header">
                        <h4><i class="fas fa-filter"></i> Filtros de Búsqueda</h4>
                        <button class="btn-limpiar-filtros" onclick="limpiarFiltrosInventario()">
                            <i class="fas fa-times"></i> Limpiar Filtros
                        </button>
                    </div>
                    <div class="filtro-body">
                        <div class="filtro-row">
                            <div class="filtro-group">
                                ...
                                <input type="text" id="filtro_inventario_codigo" placeholder="Buscar por código..." onkeyup="aplicarFiltrosInventario()">
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-info-circle"></i> Estado</label>
                                <select id="filtro_inventario_estado" onchange="aplicarFiltrosInventario()">
                            ...
                            <div class="filtro-group">
                                <label><i class="fas fa-user"></i> Usuario Asignado</label>
                                <select id="filtro_inventario_usuario" onchange="aplicarFiltrosInventario()">
                                    <option value="">Todos los usuarios</option>
                                </select>
                            </div>
                        </div>
                        <div class="filtro-row">
                            <div class="filtro-group">
                                <label><i class="fas fa-directions"></i> Dirección</label>
                                <select id="filtro_inventario_direccion" onchange="aplicarFiltrosInventario()">
                                    <option value="">Todas las direcciones</option>
                                </select>
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-sitemap"></i> Departamento</label>
                                <select id="filtro_inventario_departamento" onchange="aplicarFiltrosInventario()">
                                    <option value="">Todos los departamentos</option>
                                </select>
                            </div>
                            <div class="filtro-group">
                                <label><i class="fas fa-folder"></i> Sección</label>
                                <select id="filtro_inventario_seccion" onchange="aplicarFiltrosInventario()">
                                    <option value="">Todas las secciones</option>
                                </select>
                            </div>
                        </div>
                        <div class="filtro-row">
                            <div class="filtro-group">
                                <label><i class="fas fa-building"></i> Oficina o Seccion</label>
                                <input type="text" id="filtro_inventario_oficina" placeholder="Buscar por nombre de oficina o seccion..." onkeyup="aplicarFiltrosInventario()">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="spaces-card">
                        <div class="card-header">
                            <div class="header-content">
                                ...
                                <button class="btn-refresh" onclick="cargarItemsInventario(paginaActualInventario)" title="Actualizar lista">
                                    <i class="fas fa-sync-alt"></i>
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="items-inventario-table-container" style="display: none;">
                                ...
                                <div id="items-inventario-paginacion" class="paginacion-container" style="display: none;">
                                    ...
                                    <div class="paginacion-controls">
                                        <button id="items-inventario-btn-pagina-anterior" class="btn-pagina" onclick="cambiarPaginaInventario(-1)" disabled>
                                            <i class="fas fa-chevron-left"></i> Anterior
                                        </button>
                                        <div class="paginacion-numeros" id="items-inventario-paginacion-numeros">
                                            <!-- Los números de página se generarán aquí -->
                                        </div>
                                        <button id="items-inventario-btn-pagina-siguiente" class="btn-pagina" onclick="cambiarPaginaInventario(1)" disabled>
                                            Siguiente <i class="fas fa-chevron-right"></i>
                                        </button>
                                    </div>
                                </div>
            ...
            setTimeout(() => {
                ...
                cargarItemsInventario(1); // Empezar en la primera página
            }, 200);
            break;
                ...
                <div class="manage-spaces-container" style="margin-top: 2rem;">
                    <div class="spaces-card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Botón de Exportar PDF -->
                            <div style="margin-top: 1.5rem; text-align: center; padding: 1rem;">
                                <button class="btn-exportar-pdf" onclick="exportarHistorialPDF()" style="background: linear-gradient(135deg, #e74c3c, #c0392b); color: white; border: none; padding: 0.75rem 1.5rem; border-radius: 8px; cursor: pointer; font-size: 1rem; font-weight: 600; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0,0,0,0.15);">
    ...
    // Si se carga "Registrar Espacios", inicializar formulario
    if (opcion === 'Registrar Espacios') {
        ...
        setTimeout(() => {
            ...
            if (selectDireccion) {
                ...
                // Agregar event listeners para creación de nuevas entidades usando delegación
                const container = document.querySelector('.container');
                if (container) {
                    container.addEventListener('change', function(e) {
                        // Manejar creación de nueva dirección
                        if (e.target && e.target.id === 'id_direccion') {
                            const inputNuevaDireccion = document.getElementById('nueva_direccion_nombre');
                            if (e.target.value === '__crear_nuevo__') {
                                if (inputNuevaDireccion) {
                                    inputNuevaDireccion.style.display = 'block';
                                    inputNuevaDireccion.required = true;
                                }
                            } else {
                                if (inputNuevaDireccion) {
                                    inputNuevaDireccion.style.display = 'none';
                                    inputNuevaDireccion.required = false;
                                    inputNuevaDireccion.value = '';
                                }
                            }
                        }
                        
                        // Manejar creación de nuevo departamento
                        if (e.target && e.target.id === 'id_departamento') {
                            const inputNuevoDepartamento = document.getElementById('nuevo_departamento_nombre');
                            if (e.target.value === '__crear_nuevo__') {
                                if (inputNuevoDepartamento) {
                                    inputNuevoDepartamento.style.display = 'block';
                                    inputNuevoDepartamento.required = true;
                                }
                            } else {
                                if (inputNuevoDepartamento) {
                                    inputNuevoDepartamento.style.display = 'none';
                                    inputNuevoDepartamento.required = false;
                                    inputNuevoDepartamento.value = '';
                                }
                            }
                        }
                        
                        // Manejar creación de nueva sección
                        if (e.target && e.target.id === 'id_seccion') {
                            const inputNuevaSeccion = document.getElementById('nueva_seccion_nombre');
                            if (e.target.value === '__crear_nuevo__') {
                                if (inputNuevaSeccion) {
                ...
                console.error('El select de dirección no existe aún, reintentando...');
                // Reintentar varias veces si es necesario
                let intentos = 0;
                const intervalo = setInterval(() => {
                    ...
                    if (select) {
                        ...
                        console.error('No se pudo encontrar el select después de 10 intentos');
                        clearInterval(intervalo);
                    }
                }, 100);
            }
...
// ============================================
// FUNCIONES PARA REGISTRO DE ESPACIOS
// ============================================

let contadorItemsInventario = 0;
...
async function cargarDirecciones() {
    try {
        ...
        if (!selectDireccion) {
            console.error('No se encontró el select con id="id_direccion"');
            return;
        }
        
        if (result.success && result.data) {
            // Limpiar select completamente antes de agregar nuevas opciones
            selectDireccion.innerHTML = '<option value="">Ninguna - Oficina o Seccion independiente</option>';
            if (result.data.length > 0) {
                result.data.forEach(direccion => {
                    // Verificar si la opción ya existe antes de agregarla
                    const existingOption = selectDireccion.querySelector(`option[value="${direccion.id_direccion}"]`);
                    if (!existingOption) {
                ...
                console.warn('No hay direcciones disponibles en la base de datos');
            }
            
            // Eliminar opción "Crear Nuevo" si existe y agregarla al final
            const existingCrearOption = selectDireccion.querySelector('option[value="__crear_nuevo__"]');
            if (existingCrearOption) {
                existingCrearOption.remove();
            }
            // Agregar opción de crear nuevo al final
            const crearOption = document.createElement('option');
            crearOption.value = '__crear_nuevo__';
            crearOption.textContent = '➕ Crear Nueva Dirección';
            selectDireccion.appendChild(crearOption);
            
            // Asegurar que todos los selects estén habilitados
            ...
            // Agregar event listener para crear nueva dirección (solo una vez)
            const existingDireccionListener = selectDireccion.getAttribute('data-listener-attached');
            if (!existingDireccionListener) {
                selectDireccion.addEventListener('change', function() {
                    ...
                    cargarDepartamentos(); // Recargar departamentos al cambiar dirección
                });
                selectDireccion.setAttribute('data-listener-attached', 'true');
            }
            
            // Cargar departamentos y secciones inicialmente
            cargarDepartamentos();
            cargarSecciones();
        } else {
            console.error('Error en la respuesta:', result.message || 'Respuesta sin éxito');
            mostrarCardEmergente(false, result.message || 'Error al cargar las direcciones');
        }
    } catch (error) {
...
// Cargar departamentos según dirección
async function cargarDepartamentos() {
    ...
    if (!selectDireccion || !selectDepartamento || !selectSeccion) return;
    
    // TODOS LOS SELECTS SIEMPRE HABILITADOS - Sin restricciones
    ...
    // Manejar creación de nueva dirección
    if (idDireccion === '__crear_nuevo__') {
        if (inputNuevaDireccion) {
            inputNuevaDireccion.style.display = 'block';
            inputNuevaDireccion.required = true;
        }
        // Mantener departamento y sección habilitados con opciones
        if (!selectDepartamento.querySelector('option[value="__crear_nuevo__"]')) {
            const crearDeptOption = document.createElement('option');
            crearDeptOption.value = '__crear_nuevo__';
            crearDeptOption.textContent = '➕ Crear Nuevo Departamento';
            selectDepartamento.appendChild(crearDeptOption);
        }
        if (!selectSeccion.querySelector('option[value="__crear_nuevo__"]')) {
            const crearSecOption = document.createElement('option');
            crearSecOption.value = '__crear_nuevo__';
            crearSecOption.textContent = '➕ Crear Nueva Sección';
            selectSeccion.appendChild(crearSecOption);
        }
        if (inputNuevoDepartamento) {
            inputNuevoDepartamento.style.display = 'none';
            inputNuevoDepartamento.required = false;
    ...
    // Limpiar el select de departamento y resetear el de sección
    selectDepartamento.innerHTML = '<option value="">Ninguno - Solo Dirección</option>';
    if (selectSeccion) {
        selectSeccion.innerHTML = '<option value="">Ninguna - Solo Departamento</option>';
    }
    
    // Cargar departamentos: si hay dirección, solo de esa dirección; si no, todos sin dirección
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                id_direccion: (idDireccion && idDireccion !== '' && idDireccion !== '__crear_nuevo__') ? idDireccion : null
            })
        });
        ...
        if (result.success && result.data && result.data.length > 0) {
            // Agregar departamentos existentes (verificar duplicados)
            result.data.forEach(departamento => {
                // Verificar si la opción ya existe antes de agregarla
                const existingOption = selectDepartamento.querySelector(`option[value="${departamento.id_departamento}"]`);
                if (!existingOption) {
                    const option = document.createElement('option');
        ...
        // Eliminar opción "Crear Nuevo" si existe y agregarla al final
        const existingCrearOption = selectDepartamento.querySelector('option[value="__crear_nuevo__"]');
        if (existingCrearOption) {
            existingCrearOption.remove();
        }
        // Agregar opción de crear nuevo al final
        const crearOption = document.createElement('option');
        crearOption.value = '__crear_nuevo__';
        crearOption.textContent = '➕ Crear Nuevo Departamento';
        selectDepartamento.appendChild(crearOption);
        
        // Recargar secciones después de cargar departamentos (sin departamento seleccionado)
        cargarSecciones();
    } catch (error) {
...
async function cargarUsuarios() {
    try {
        ...
        const selectUsuario = document.getElementById('id_usuario_asignacion');
        
        if (!selectUsuario) {
            console.error('No se encontró el select con id="id_usuario_asignacion"');
            return;
        }
        
        if (result.success && result.data) {
            selectUsuario.innerHTML = '<option value="">Ninguno - Sin asignar</option>';
            if (result.data.length > 0) {
...
// Cargar secciones según departamento
async function cargarSecciones() {
    ...
    if (!selectDepartamento || !selectSeccion) return;
    ...
    let idDepartamento = selectDepartamento.value;
    const idDireccion = selectDireccion ? selectDireccion.value : null;
    
    // Manejar creación de nuevo departamento
    if (idDepartamento === '__crear_nuevo__') {
        if (inputNuevoDepartamento) {
            inputNuevoDepartamento.style.display = 'block';
            inputNuevoDepartamento.required = true;
        }
        ...
        // Continuar para cargar secciones sin departamento
        idDepartamento = null; // Forzar a null para cargar secciones sin departamento
    } else {
        if (inputNuevoDepartamento) {
            inputNuevoDepartamento.style.display = 'none';
            inputNuevoDepartamento.required = false;
    ...
    // Limpiar el select de sección
    selectSeccion.innerHTML = '<option value="">Ninguna - Solo Departamento</option>';
    
    // Manejar creación de nueva sección (solo una vez, no múltiples event listeners)
    const existingListener = selectSeccion.getAttribute('data-listener-attached');
    if (!existingListener) {
        ...
        selectSeccion.setAttribute('data-listener-attached', 'true');
    }
    
    // Cargar secciones: si hay departamento, solo de ese departamento; si no, todas sin departamento
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
                ...
                id_departamento: (idDepartamento && idDepartamento !== '' && idDepartamento !== '__crear_nuevo__') ? idDepartamento : null
            })
        });
        ...
        if (result.success && result.data && result.data.length > 0) {
            // Agregar secciones existentes (verificar duplicados)
            result.data.forEach(seccion => {
                // Verificar si la opción ya existe antes de agregarla
                const existingOption = selectSeccion.querySelector(`option[value="${seccion.id_seccion}"]`);
                if (!existingOption) {
                    const option = document.createElement('option');
        ...
        // Eliminar opción "Crear Nuevo" si existe y agregarla al final
        const existingCrearOption = selectSeccion.querySelector('option[value="__crear_nuevo__"]');
        if (existingCrearOption) {
            existingCrearOption.remove();
        }
        // Agregar opción de crear nuevo al final
        const crearOption = document.createElement('option');
        crearOption.value = '__crear_nuevo__';
        crearOption.textContent = '➕ Crear Nueva Sección';
        selectSeccion.appendChild(crearOption);
    } catch (error) {
...
async function cargarTiposBien() {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (result.success) {
            // Guardar tipos de bien para usar en los items de inventario
...
function agregarItemInventario() {
    ...
    // Calcular el número del item basado en cuántos items hay actualmente
    const itemsActuales = container.querySelectorAll('.inventario-item');
    const numeroItem = itemsActuales.length + 1;
    ...
    itemDiv.id = `item-inventario-${itemId}`;
    itemDiv.setAttribute('data-item-numero', numeroItem);
    
    itemDiv.innerHTML = `
        <div class="item-header">
            <h4><i class="fas fa-box"></i> Item ${numeroItem}</h4>
            <button type="button" class="btn-remove-item" onclick="eliminarItemInventarioFormulario('${itemId}')">
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" name="inventario[${itemId}][codigo_patrimonial]" required placeholder="Ej: PAT-001">
            </div>
            <div class="form-group">
                <label>Tipo de Bien *</label>
                <select name="inventario[${itemId}][id_tipo_bien]" required>
                    <option value="">Seleccione un tipo</option>
                </select>
                <input type="text" name="inventario[${itemId}][nuevo_tipo_bien]" placeholder="Nombre del nuevo tipo de bien" style="display: none; margin-top: 8px;" class="nuevo-campo-input">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
                <label>Descripción</label>
                <input type="text" name="inventario[${itemId}][descripcion]" placeholder="Ej: Escritorio ejecutivo">
            </div>
            <div class="form-group">
                <label>Marca</label>
                <input type="text" name="inventario[${itemId}][marca]" placeholder="Ej: HP">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
                <label>Modelo</label>
                <input type="text" name="inventario[${itemId}][modelo]" placeholder="Ej: EliteBook 840">
            </div>
            <div class="form-group">
                <label>Serie</label>
                <input type="text" name="inventario[${itemId}][serie]" placeholder="Ej: SN123456">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group">
                <label>Estado</label>
                <select name="inventario[${itemId}][estado]">
            ...
            <div class="form-group">
                ...
                <input type="date" name="inventario[${itemId}][fecha_ingreso]">
            </div>
        </div>
    `;
...
// Eliminar item de inventario del formulario
function eliminarItemInventarioFormulario(itemId) {
    const item = document.getElementById(`item-inventario-${itemId}`);
    if (item) {
        item.remove();
        // Renumerar todos los items después de eliminar
        renumerarItemsInventario();
    }
}

// Renumerar items de inventario
function renumerarItemsInventario() {
    const container = document.getElementById('inventario-items');
    if (!container) return;
    
    const items = container.querySelectorAll('.inventario-item');
    items.forEach((item, index) => {
        const numeroItem = index + 1;
        const header = item.querySelector('.item-header h4');
        if (header) {
            header.innerHTML = `<i class="fas fa-box"></i> Item ${numeroItem}`;
        }
        item.setAttribute('data-item-numero', numeroItem);
    });
}
...
async function registrarEspacio(event) {
    ...
    const form = document.getElementById('formRegistrarEspacio');
    if (!form) return;
    
    const formData = new FormData(form);
    
    // Obtener valores y convertir strings vacíos a null
    const idDireccion = formData.get('id_direccion');
    const idDepartamento = formData.get('id_departamento');
    const idSeccion = formData.get('id_seccion');
    const nuevaDireccionNombre = formData.get('nueva_direccion_nombre');
    const nuevoDepartamentoNombre = formData.get('nuevo_departamento_nombre');
    const nuevaSeccionNombre = formData.get('nueva_seccion_nombre');
    const idUsuarioAsignacion = formData.get('id_usuario_asignacion');
    
    const data = {
        action: 'registrar_espacio',
        oficina: {
            nombre: formData.get('nombre_oficina'),
            edificio: formData.get('edificio_oficina') || null,
            piso: formData.get('piso_oficina') || null,
            ubicacion_fisica: formData.get('ubicacion_fisica') || null,
            id_direccion: (idDireccion && idDireccion !== '' && idDireccion !== '__crear_nuevo__') ? idDireccion : null,
            id_departamento: (idDepartamento && idDepartamento !== '' && idDepartamento !== '__crear_nuevo__') ? idDepartamento : null,
            id_seccion: (idSeccion && idSeccion !== '' && idSeccion !== '__crear_nuevo__') ? idSeccion : null
        },
        // Datos para crear nuevas entidades
        crear: {
            nueva_direccion: (idDireccion === '__crear_nuevo__' && nuevaDireccionNombre) ? nuevaDireccionNombre.trim() : null,
            nuevo_departamento: (idDepartamento === '__crear_nuevo__' && nuevoDepartamentoNombre) ? nuevoDepartamentoNombre.trim() : null,
            nueva_seccion: (idSeccion === '__crear_nuevo__' && nuevaSeccionNombre) ? nuevaSeccionNombre.trim() : null
        },
        // Datos de asignación de usuario
        asignacion: {
            id_usuario: (idUsuarioAsignacion && idUsuarioAsignacion !== '') ? idUsuarioAsignacion : null
        },
        inventario: []
    };
    
    // Recopilar items de inventario
    const inventarioItems = form.querySelectorAll('.inventario-item');
    inventarioItems.forEach(item => {
        const selectTipoBien = item.querySelector('select[name*="[id_tipo_bien]"]');
        const inputNuevoTipoBien = item.querySelector('input[name*="[nuevo_tipo_bien]"]');
        const idTipoBien = selectTipoBien ? selectTipoBien.value : '';
        const nuevoTipoBien = inputNuevoTipoBien ? inputNuevoTipoBien.value.trim() : '';
        
        const itemData = {
            codigo_patrimonial: item.querySelector('input[name*="[codigo_patrimonial]"]').value,
            id_tipo_bien: (idTipoBien && idTipoBien !== '' && idTipoBien !== '__crear_nuevo__') ? idTipoBien : null,
            nuevo_tipo_bien: (idTipoBien === '__crear_nuevo__' && nuevoTipoBien) ? nuevoTipoBien : null,
            descripcion: item.querySelector('input[name*="[descripcion]"]').value || null,
            marca: item.querySelector('input[name*="[marca]"]').value || null,
            modelo: item.querySelector('input[name*="[modelo]"]').value || null,
            serie: item.querySelector('input[name*="[serie]"]').value || null,
            estado: item.querySelector('select[name*="[estado]"]').value || null,
            fecha_ingreso: item.querySelector('input[name*="[fecha_ingreso]"]').value || null
        };
        data.inventario.push(itemData);
    });
    ...
    try {
        ...
        if (result.success) {
            mostrarCardEmergente(true, result.message || 'Espacio registrado correctamente');
            limpiarFormulario();
            // Actualizar la tabla de espacios (ir a la primera página)
            cargarEspacios(1);
        } else {
            mostrarCardEmergente(false, result.message || 'Error al registrar el espacio');
        }
    } catch (error) {
        console.error('Error al registrar espacio:', error);
        mostrarCardEmergente(false, 'Error al registrar el espacio. Por favor, intente nuevamente.');
    }
}
...
function limpiarFormulario() {
    ...
    if (form) {
        form.reset();
        document.getElementById('inventario-items').innerHTML = '';
        // No necesitamos resetear contador ya que usamos IDs únicos basados en timestamp
        ...
        if (selectDepartamento) {
            selectDepartamento.innerHTML = '<option value="">Ninguno - Solo Dirección</option><option value="__crear_nuevo__">➕ Crear Nuevo Departamento</option>';
            selectDepartamento.disabled = false;
        }
        if (selectSeccion) {
            selectSeccion.innerHTML = '<option value="">Ninguna - Solo Departamento</option><option value="__crear_nuevo__">➕ Crear Nueva Sección</option>';
            selectSeccion.disabled = false;
        }
    }
}
...
// ============================================
// FUNCIONES PARA GESTIÓN DE ESPACIOS
// ============================================
...
// Cargar espacios
async function cargarEspacios(pagina = 1) {
    paginaActual = pagina;
    ...
    try {
        ...
        if (result.success && result.data && result.data.length > 0) {
                    ...
                    <td>
                        <div class="action-menu-container">
                            ...
                            <div class="action-menu" id="action-menu-${espacio.id_oficina}" style="display: none;">
                                <button class="action-menu-item" onclick="verDetalleEspacio(${espacio.id_oficina}); closeAllActionMenus();">
                                    <i class="fas fa-eye"></i> Ver Detalles
                                </button>
                                <button class="action-menu-item" onclick="editarEspacio(${espacio.id_oficina}); closeAllActionMenus();">
                                    <i class="fas fa-edit"></i> Editar
                                </button>
                                <button class="action-menu-item" onclick="exportarEspacioPDF(${espacio.id_oficina}); closeAllActionMenus();">
                                    <i class="fas fa-file-pdf"></i> Exportar PDF
                                </button>
                                <button class="action-menu-item action-menu-item-danger" onclick="eliminarEspacio(${espacio.id_oficina}, '${nombreEscapado}'); closeAllActionMenus();">
            ...
            if (result.paginacion && paginacionContainer) {
                actualizarPaginacion(result.paginacion);
...
function actualizarPaginacion(paginacion) {
    ...
    if (finPagina < totalPaginas) {
        ...
        btn.onclick = () => irAPagina(totalPaginas);
        numerosContainer.appendChild(btn);
    }
}
    ...
    try {
        ...
        if (selectDireccion && resultDirecciones.success && resultDirecciones.data) {
            ...
            selectDireccion.onchange = function() {
                cargarDepartamentosFiltro(this.value);
                aplicarFiltros();
            };
        }
        
        // Cargar departamentos (sin filtro inicial)
        cargarDepartamentosFiltro(null);
...
async function cargarDepartamentosFiltro(id_direccion) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (selectDepartamento && result.success && result.data) {
            ...
            selectDepartamento.onchange = function() {
                cargarSeccionesFiltro(this.value);
                aplicarFiltros();
            };
        }
    } catch (error) {
...
async function cargarSeccionesFiltro(id_departamento) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
...
function aplicarFiltros() {
    cargarEspacios(1); // Resetear a la primera página al aplicar filtros
}
...
function limpiarFiltros() {
    ...
    cargarDepartamentosFiltro(null);
    cargarSeccionesFiltro(null);
    
    // Recargar espacios sin filtros (ir a la primera página)
    cargarEspacios(1);
}

// Cargar opciones para los filtros de inventario
async function cargarFiltrosInventario() {
    try {
        ...
        if (selectDireccion && resultDirecciones.success && resultDirecciones.data) {
            ...
            selectDireccion.onchange = function() {
                cargarDepartamentosFiltroInventario(this.value);
                aplicarFiltrosInventario();
            };
        }
        
        // Cargar departamentos (sin filtro inicial)
        cargarDepartamentosFiltroInventario(null);
...
async function cargarDepartamentosFiltroInventario(id_direccion) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (selectDepartamento && result.success && result.data) {
            ...
            // Agregar event listener
            selectDepartamento.onchange = function() {
                cargarSeccionesFiltroInventario(this.value);
                aplicarFiltrosInventario();
            };
        }
    } catch (error) {
...
async function cargarSeccionesFiltroInventario(id_departamento) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
...
function aplicarFiltrosInventario() {
    cargarItemsInventario(1); // Resetear a la primera página al aplicar filtros
}
...
function limpiarFiltrosInventario() {
    ...
    // Recargar departamentos y secciones sin filtros
    cargarDepartamentosFiltroInventario(null);
    cargarSeccionesFiltroInventario(null);
    
    // Recargar items sin filtros (ir a la primera página)
    cargarItemsInventario(1);
}

// Cargar items de inventario
async function cargarItemsInventario(pagina = 1) {
    ...
    const filtros = {
        ...
        marca: document.getElementById('filtro_inventario_marca')?.value || null,
        modelo: document.getElementById('filtro_inventario_modelo')?.value || null,
        serie: document.getElementById('filtro_inventario_serie')?.value || null,
        descripcion: document.getElementById('filtro_inventario_descripcion')?.value || null,
        ...
        if (result.success && result.data && result.data.length > 0) {
            ...
            result.data.forEach(item => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <div class="action-menu-container">
                            <button class="btn-menu-toggle" onclick="toggleActionMenuInventario(${item.id_inventario}, event)" title="Opciones">
                                <i class="fas fa-ellipsis-v"></i>
                            </button>
                            <div class="action-menu" id="action-menu-inventario-${item.id_inventario}" style="display: none;">
                                <button class="action-menu-item" onclick="asignarItemInventario(${item.id_inventario}); closeAllActionMenusInventario();">
                                    <i class="fas fa-user-plus"></i> Asignar A
                                </button>
                                <button class="action-menu-item" onclick="moverItemInventarioDesdeTabla(${item.id_inventario}); closeAllActionMenusInventario();">
                                    <i class="fas fa-arrows-alt"></i> Mover A
                                </button>
                                ${item.ubicacion !== 'Sin asignar' ? `
                                <button class="action-menu-item" onclick="eliminarAsignacionItem(${item.id_inventario}, '${codigoEscapado}'); closeAllActionMenusInventario();">
                                    <i class="fas fa-unlink"></i> Eliminar Asignación
                                </button>
                                ` : ''}
                                ${item.activo === 'Activo' || item.activo === 1 || item.activo === '1' ? `
                                <button class="action-menu-item action-menu-item-danger" onclick="darBajaItemInventarioDesdeTabla(${item.id_inventario}); closeAllActionMenusInventario();">
                                    <i class="fas fa-ban"></i> Dar de Baja
                                </button>
                                ` : ''}
                                <button class="action-menu-item action-menu-item-danger" onclick="eliminarItemInventario(${item.id_inventario}, '${codigoEscapado}'); closeAllActionMenusInventario();">
                                    <i class="fas fa-trash"></i> Eliminar
                                </button>
                            </div>
                        </div>
            ...
            // Mostrar y actualizar controles de paginación
            if (result.paginacion && paginacionContainer) {
                actualizarPaginacionInventario(result.paginacion);
                paginacionContainer.style.display = 'flex';
            }
        } else {
            // Mostrar estado vacío
...
function cambiarPaginaInventario(direccion) {
    ...
    if (nuevaPagina >= 1) {
        cargarItemsInventario(nuevaPagina);
    }
}
...
function actualizarPaginacionInventario(paginacion) {
    ...
    if (inicioPagina > 1) {
        ...
        btn.className = 'btn-pagina-numero';
        btn.textContent = '1';
        btn.onclick = () => irAPaginaInventario(1);
        numerosContainer.appendChild(btn);
    ...
    for (let i = inicioPagina; i <= finPagina; i++) {
        ...
        btn.textContent = i;
        btn.onclick = () => irAPaginaInventario(i);
        numerosContainer.appendChild(btn);
    }
    ...
    if (finPagina < totalPaginas) {
        ...
        btn.className = 'btn-pagina-numero';
        btn.textContent = totalPaginas;
        btn.onclick = () => irAPaginaInventario(totalPaginas);
        numerosContainer.appendChild(btn);
    }
}

// Ver detalle de espacio
async function verDetalleEspacio(id_oficina) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
...
document.addEventListener('click', function(event) {
    const modalDetalle = document.getElementById('modal-detalle-espacio');
    const modalEditar = document.getElementById('modal-editar-espacio');
...
// Editar espacio
async function editarEspacio(id_oficina) {
    console.log('editarEspacio llamado con id_oficina:', id_oficina);
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
        ...
        return;
            ...
            modalBody.innerHTML = `
                <form id="form-editar-espacio" onsubmit="guardarEdicionEspacio(event, ${id_oficina})">
                    ...
                    <div class="form-section-editar">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                            ...
                            <button type="button" class="btn-add-item-editar" onclick="agregarItemInventarioEditar()">
                                <i class="fas fa-plus"></i> Agregar Item
                            </button>
                        </div>
                            ...
                            ${espacio.items && espacio.items.length > 0 ? (() => {
                                ...
                                <div class="item-inventario-editar" data-item-id="${item.id_inventario}">
                                    <div class="item-header-editar">
                                        ...
                                        <div>
                                            <button type="button" class="btn-mover-item" onclick="moverItemInventario(${item.id_inventario}, ${id_oficina})" title="Mover a otra área">
                                                <i class="fas fa-exchange-alt"></i> Mover
                                            </button>
                                            <button type="button" class="btn-baja-item" onclick="darBajaItemInventario(${item.id_inventario}, ${id_oficina})" title="Dar de baja">
                                                <i class="fas fa-ban"></i> Baja
                                            </button>
                                            <button type="button" class="btn-remove-item-editar" onclick="quitarItemInventarioEditar(${item.id_inventario})" title="Quitar de esta oficina o seccion">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </div>
                                    </div>
            ...
            await cargarUsuariosParaEditar(idUsuarioAsignacion);
            
            // Cargar otros datos en paralelo
            await Promise.all([
                cargarDireccionesParaEditar(),
                cargarTiposBienParaEditar()
            ]);
            ...
            if (espacio.id_direccion) {
                setTimeout(() => {
                    ...
                    if (selectDireccion) {
                        ...
                        cargarDepartamentosParaEditar(espacio.id_direccion, espacio.id_departamento, espacio.id_seccion);
                    }
                }, 500);
            } else {
                cargarDepartamentosParaEditar(null, espacio.id_departamento, espacio.id_seccion);
            }
...
function agregarItemInventarioEditar() {
    ...
    itemDiv.innerHTML = `
        <div class="item-header-editar">
            ...
            <button type="button" class="btn-remove-item-editar" onclick="eliminarItemNuevoEditar('${itemId}')">
                <i class="fas fa-times"></i>
            </button>
        </div>
        <div class="form-row-editar">
...
function eliminarItemNuevoEditar(itemId) {
    const item = document.getElementById(`item-editar-${itemId}`);
    if (item) {
        item.remove();
        itemsAgregarEditar = itemsAgregarEditar.filter(id => id !== itemId);
    }
}

// Quitar item de inventario en edición
async function quitarItemInventarioEditar(id_inventario) {
    ...
    mostrarCardConfirmacion(
        ...
        async () => {
            ...
            await confirmarQuitarItemEditar(id_inventario);
        },
        () => {
...
async function confirmarQuitarItemEditar(id_inventario) {
    try {
        ...
        if (result.success) {
            ...
            if (!itemsQuitarEditar.includes(id_inventario)) {
                itemsQuitarEditar.push(id_inventario);
            }
            
            // Recargar la tabla de espacios para actualizar el número de items
            cargarEspacios(paginaActual);
...
async function moverItemInventario(id_inventario, id_oficina_actual) {
    ...
    if (result.success) {
        ...
        mostrarModalMoverItem(id_inventario, item, id_oficina_actual);
    } else {
...
async function darBajaItemInventario(id_inventario, id_oficina) {
    // Obtener datos del item actual
    const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
        method: 'POST',
        headers: {
    ...
    if (result.success) {
        const item = result.data;
        mostrarModalBajaItem(id_inventario, item, id_oficina);
    } else {
        mostrarCardEmergente(false, 'Error al obtener datos del item');
    }
}

// Dar de baja item de inventario (desde tabla de inventario)
async function darBajaItemInventarioDesdeTabla(id_inventario) {
    // Obtener datos del item actual
    const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
        method: 'POST',
        headers: {
    ...
    if (result.success) {
        const item = result.data;
        mostrarModalBajaItem(id_inventario, item, null, true); // true indica que viene de la tabla
    } else {
        mostrarCardEmergente(false, 'Error al obtener datos del item');
    }
}
...
function mostrarModalBajaItem(id_inventario, item, id_oficina = null, desdeTabla = false) {
        ...
        <div id="modal-baja-item" class="modal-detalle-overlay" style="display: flex;">
            <div class="modal-detalle-content" style="max-width: 500px;">
                <div class="modal-detalle-header">
                    ...
                    <button class="modal-detalle-close" onclick="cerrarModalBajaItem()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                ...
                <div class="modal-detalle-footer">
                    <button type="button" class="btn-modal-cancel" onclick="cerrarModalBajaItem()">Cancelar</button>
                    <button type="button" class="btn-modal-save" style="background: #e74c3c;" onclick="confirmarBajaItem(${id_inventario}, ${idOficinaParam}, ${desdeTablaParam})">Dar de Baja</button>
                </div>
            </div>
        </div>
    `;
...
async function confirmarBajaItem(id_inventario, id_oficina = null, desdeTabla = false) {
    ...
    try {
        ...
        if (result.success) {
            ...
            if (desdeTabla) {
                ...
                cargarItemsInventario(paginaActualInventario);
            } else {
                ...
                if (id_oficina_input) {
                    editarEspacio(parseInt(id_oficina_input.value));
                }
...
function mostrarModalMoverItem(id_inventario, item, id_oficina_actual) {
        ...
        <div id="modal-mover-item" class="modal-detalle-overlay" style="display: flex;">
            <div class="modal-detalle-content" style="max-width: 500px;">
                <div class="modal-detalle-header">
                    ...
                    <button class="modal-detalle-close" onclick="cerrarModalMoverItem()">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <div class="modal-detalle-body">
                    ...
                    <div class="form-group-editar" style="margin-top: 1rem;">
                        ...
                        <select id="mover_oficina_general" onchange="seleccionarOficinaGeneral(this.value)">
                            <option value="">Seleccione una oficina o seccion...</option>
                        </select>
                    </div>
                ...
                <div class="modal-detalle-footer">
                    <button type="button" class="btn-modal-cancel" onclick="cerrarModalMoverItem()">Cancelar</button>
                    <button type="button" class="btn-modal-save" onclick="confirmarMoverItem(${id_inventario}, ${id_oficina_actual})">Mover Item</button>
                </div>
            </div>
        </div>
    `;
...
async function confirmarMoverItem(id_inventario, id_oficina_actual) {
    ...
    try {
        ...
        if (result.success) {
            ...
            // Recargar la tabla de inventario si está visible
            const tablaInventario = document.getElementById('items-inventario-table-container');
...
async function guardarEdicionEspacio(event, id_oficina) {
    event.preventDefault();
    ...
    const formData = {
        ...
        id_usuario_responsable: id_usuario_responsable,
        items_quitar: itemsQuitarEditar,
        items_agregar: {}
    };
    ...
    try {
        ...
        if (result.success) {
            ...
            cerrarModalEditar();
            cargarEspacios(paginaActual); // Recargar la lista manteniendo la página actual
        } else {
...
async function cargarDireccionesParaEditar() {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (select && result.success && result.data) {
            ...
            select.addEventListener('change', function() {
                cargarDepartamentosParaEditar(this.value);
            });
        }
    } catch (error) {
        console.error('Error al cargar direcciones:', error);
...
async function cargarDepartamentosParaEditar(id_direccion = null, id_departamento_seleccionado = null, id_seccion_seleccionada = null) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (select && result.success && result.data) {
            ...
            select.addEventListener('change', function() {
                cargarSeccionesParaEditar(this.value);
            });
            
            // Cargar secciones si hay departamento seleccionado
            if (id_departamento_seleccionado) {
                cargarSeccionesParaEditar(id_departamento_seleccionado, id_seccion_seleccionada);
            }
        }
    } catch (error) {
        console.error('Error al cargar departamentos:', error);
...
async function cargarSeccionesParaEditar(id_departamento = null, id_seccion_seleccionada = null) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
...
async function cargarUsuariosParaEditar(idUsuarioAsignacion = null) {
...
async function cargarTiposBienParaEditar() {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
...
async function cargarDireccionesParaMover() {
    // Similar a cargarDireccionesParaEditar pero para el modal de mover
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        const result = await response.json();
        const select = document.getElementById('mover_destino_direccion');
        ...
        if (select && result.success && result.data) {
            ...
            select.addEventListener('change', function() {
                cargarDepartamentosParaMover(this.value);
            });
        }
    } catch (error) {
        console.error('Error al cargar direcciones:', error);
...
async function cargarDepartamentosParaMover(id_direccion = null) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        const result = await response.json();
        const select = document.getElementById('mover_destino_departamento');
        ...
        if (select && result.success && result.data) {
            ...
            select.addEventListener('change', function() {
                cargarSeccionesParaMover(this.value);
            });
        }
    } catch (error) {
        console.error('Error al cargar departamentos:', error);
...
async function cargarSeccionesParaMover(id_departamento = null) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Registroespacios.php', {
            method: 'POST',
            headers: {
        ...
        const result = await response.json();
        const select = document.getElementById('mover_destino_seccion');
        ...
        if (select && result.success && result.data) {
            ...
            select.addEventListener('change', function() {
                cargarOficinasParaMover(this.value, document.getElementById('mover_destino_departamento')?.value);
            });
        }
    } catch (error) {
        console.error('Error al cargar secciones:', error);
...
async function cargarOficinasParaMover(id_seccion = null, id_departamento = null) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
        ...
        const result = await response.json();
        const select = document.getElementById('mover_destino_oficina');
        
        if (select && result.success && result.data) {
            select.innerHTML = '<option value="">Ninguna</option>';
            result.data.forEach(oficina => {
                const option = document.createElement('option');
...
// Eliminar espacio
async function eliminarEspacio(id_oficina, nombre) {
    ...
    mostrarCardConfirmacion(
        ...
        if (result.success) {
                    ...
                    const nuevaPagina = paginaActual > 1 ? paginaActual : 1;
                    cargarEspacios(nuevaPagina);
        } else {
...
// ============================================
// FUNCIONES PARA ACCIONES DE ITEMS DE INVENTARIO
// ============================================

// Toggle action menu para items de inventario
function toggleActionMenuInventario(id_inventario, event) {
    // Cerrar todos los demás menús primero
    closeAllActionMenusInventario();
...
function closeAllActionMenusInventario() {
...
// Ver detalle de item de inventario
async function verDetalleItemInventario(id_inventario) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (result.success && result.data) {
            ...
            // Crear modal de detalle (similar al de espacios)
            const modal = document.getElementById('modal-detalle-espacio');
            if (modal) {
                const modalBody = modal.querySelector('.modal-detalle-body');
                if (modalBody) {
                    modalBody.innerHTML = `
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-barcode"></i> Codigo Articulo
                            </div>
                            <div class="detalle-value">${item.codigo_patrimonial || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-tag"></i> Tipo de Bien
                            </div>
                            <div class="detalle-value">${item.tipo_bien || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-info-circle"></i> Descripción
                            </div>
                            <div class="detalle-value">${item.descripcion || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-industry"></i> Marca
                            </div>
                            <div class="detalle-value">${item.marca || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-cube"></i> Modelo
                            </div>
                            <div class="detalle-value">${item.modelo || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-hashtag"></i> Serie
                            </div>
                            <div class="detalle-value">${item.serie || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-check-circle"></i> Estado
                            </div>
                            <div class="detalle-value">${item.estado || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-calendar"></i> Fecha de Ingreso
                            </div>
                            <div class="detalle-value">${item.fecha_ingreso || 'N/A'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-map-marker-alt"></i> Ubicación
                            </div>
                            <div class="detalle-value">${item.ubicacion || 'Sin asignar'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-user"></i> Usuario Asignado
                            </div>
                            <div class="detalle-value">${item.usuario_asignado || 'Sin asignar'}</div>
                        </div>
                        <div class="detalle-item">
                            <div class="detalle-label">
                                <i class="fas fa-toggle-on"></i> Estado del Item
                            </div>
                            <div class="detalle-value">
                                <span class="badge-inventario ${item.activo === 1 ? 'badge-success' : 'badge-danger'}">
                                    ${item.activo === 1 ? 'Activo' : 'De Baja'}
                                </span>
                            </div>
                        </div>
                    `;
            ...
            mostrarCardEmergente(false, result.message || 'Error al obtener el detalle del item');
        }
    } catch (error) {
        console.error('Error al obtener detalle de item:', error);
        mostrarCardEmergente(false, 'Error al obtener el detalle del item. Por favor, intente nuevamente.');
    }
}

// Eliminar item de inventario
async function eliminarItemInventario(id_inventario, codigo_patrimonial) {
...
async function asignarItemInventario(id_inventario) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (result.success && result.data) {
            ...
            mostrarModalAsignarItem(id_inventario, item);
        } else {
...
function mostrarModalAsignarItem(id_inventario, item) {
        ...
        <div id="modal-asignar-item" class="modal-detalle-overlay" style="display: flex;">
            <div class="modal-detalle-content" style="max-width: 500px;">
                ...
                <div class="modal-detalle-body">
                    ...
                    <div class="form-group-editar" style="margin-top: 1rem;">
                        <label><i class="fas fa-building"></i> Seleccionar Oficina o Seccion Destino</label>
                        <select id="asignar_oficina_general" onchange="seleccionarOficinaGeneralAsignar(this.value)">
                            <option value="">Seleccione una oficina o seccion...</option>
                        </select>
                    </div>
                ...
                <div class="modal-detalle-footer">
                    <button type="button" class="btn-modal-cancel" onclick="cerrarModalAsignarItem()">Cancelar</button>
                    <button type="button" class="btn-modal-save" onclick="confirmarAsignarItem(${id_inventario})">Asignar Item</button>
                </div>
            </div>
        </div>
    `;
    ...
    // Cargar opciones
    cargarOficinasGeneralesAsignar();
}

// Cerrar modal asignar
function cerrarModalAsignarItem() {
...
async function cargarOficinasGeneralesAsignar() {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
...
async function seleccionarOficinaGeneralAsignar(id_oficina) {
    // Esta función no necesita hacer nada especial
}

// Confirmar asignar item
async function confirmarAsignarItem(id_inventario) {
...
async function eliminarAsignacionItem(id_inventario, codigo_patrimonial) {
    const codigoEscapado = escapeHtml(codigo_patrimonial);
    mostrarCardConfirmacion(
        '¿Eliminar Asignación?',
...
async function exportarEspacioPDF(id_oficina) {
    try {
...
async function exportarInventarioPDF() {
    try {
        ...
        const filtros = {
            codigo_patrimonial: document.getElementById('filtro_inventario_codigo')?.value.trim() || null,
            estado: document.getElementById('filtro_inventario_estado')?.value || null,
            id_direccion: document.getElementById('filtro_inventario_direccion')?.value || null,
            id_departamento: document.getElementById('filtro_inventario_departamento')?.value || null,
            id_seccion: document.getElementById('filtro_inventario_seccion')?.value || null,
            nombre_oficina: document.getElementById('filtro_inventario_oficina')?.value.trim() || null,
            id_usuario: document.getElementById('filtro_inventario_usuario')?.value || null
        };

        // Obtener todos los items de inventario sin paginación (respetando los filtros aplicados)
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        if (filtros.codigo_patrimonial) filtrosAplicados.push(`Código: ${filtros.codigo_patrimonial}`);
        if (filtros.estado) filtrosAplicados.push(`Estado: ${filtros.estado === '1' ? 'Activo' : 'De Baja'}`);
        if (filtros.id_direccion) {
            const selectDireccion = document.getElementById('filtro_inventario_direccion');
            const direccionNombre = selectDireccion?.options[selectDireccion.selectedIndex]?.text || filtros.id_direccion;
            filtrosAplicados.push(`Dirección: ${direccionNombre}`);
        }
        if (filtros.id_departamento) {
            const selectDepartamento = document.getElementById('filtro_inventario_departamento');
            const departamentoNombre = selectDepartamento?.options[selectDepartamento.selectedIndex]?.text || filtros.id_departamento;
            filtrosAplicados.push(`Departamento: ${departamentoNombre}`);
        }
        if (filtros.id_seccion) {
            const selectSeccion = document.getElementById('filtro_inventario_seccion');
            const seccionNombre = selectSeccion?.options[selectSeccion.selectedIndex]?.text || filtros.id_seccion;
            filtrosAplicados.push(`Sección: ${seccionNombre}`);
        }
        if (filtros.nombre_oficina) filtrosAplicados.push(`Oficina: ${filtros.nombre_oficina}`);
        if (filtros.id_usuario) {
            const selectUsuario = document.getElementById('filtro_inventario_usuario');
            const usuarioNombre = selectUsuario?.options[selectUsuario.selectedIndex]?.text || filtros.id_usuario;
            filtrosAplicados.push(`Usuario: ${usuarioNombre}`);
        }

        if (filtrosAplicados.length > 0) {
            doc.setFontSize(10);
            doc.setTextColor(...colorGris);
            doc.text(`Filtros aplicados: ${filtrosAplicados.join(', ')}`, 20, yPos);
            yPos += 6;
        }
        ...
        doc.setFont('helvetica', 'bold');
        doc.setTextColor(...colorAzul);
        doc.text(`Total de items: ${result.data.length}`, 20, yPos);
        yPos += 8;
...
async function cargarEstadisticasDashboardInventario() {
    try {
        ...
        if (result.success && result.data) {
            ...
            document.getElementById('stat-items-activos').textContent = stats.items_activos || 0;
            document.getElementById('stat-items-baja').textContent = stats.items_baja || 0;
            
            // Movimientos
            document.getElementById('stat-total-cambios').textContent = stats.total_cambios || 0;
        ...
        document.getElementById('stat-items-activos').textContent = '-';
        document.getElementById('stat-items-baja').textContent = '-';
        document.getElementById('stat-total-cambios').textContent = '-';
...
async function cargarMovimientos() {
    ...
    try {
        ...
        if (!id_usuario) {
            mostrarCardEmergente(false, 'No se pudo identificar al usuario');
            loadingState.style.display = 'none';
            return;
        }
        ...
        if (result.success && result.data && result.data.length > 0) {
            ...
            result.data.forEach((movimiento) => {
                ...
                row.innerHTML = `
                    ...
                    <td>
                        <button class="btn-accion btn-accion-primary" onclick="marcarMovimientoRevisado(${movimiento.id_movimiento})" title="Marcar como revisado">
...
async function cargarHistorialMovimientos(pagina = 1) {
    ...
    try {
        ...
        const response = await fetch(getAppBasePath() + '/config/Movimientos.php', {
            ...
            body: JSON.stringify({
                action: 'listar_todos_movimientos',
                pagina: pagina,
                limite: limite,
                filtros: filtros
            })
...
// Exportar historial de cambios a PDF
async function exportarHistorialPDF() {
    try {
        ...
        // Obtener todos los movimientos sin paginación (con los filtros aplicados)
        const response = await fetch(getAppBasePath() + '/config/Movimientos.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        if (!result.success || !result.data || result.data.length === 0) {
            mostrarCardEmergente(false, 'No hay movimientos para exportar. Ajuste los filtros e intente nuevamente.');
            return;
        }
        ...
        doc.setTextColor(...colorAzul);
        doc.setFont('helvetica', 'bold');
        doc.text('HISTORIAL DE CAMBIOS', 20, 20);

        // Texto descriptivo
        doc.setFontSize(12);
        doc.setTextColor(...colorGris);
        doc.setFont('helvetica', 'normal');
        const textoDescripcion = 'Este es un documento del historial completo de cambios y movimientos del inventario de la Municipalidad de Tomé';
        doc.text(textoDescripcion, 20, 30);
        ...
        if (filtros.tipo_movimiento) {
            const tipoTextos = {
                ...
                'DESASIGNACION': 'Desasignado'
            };
            filtrosAplicados.push(`Tipo: ${tipoTextos[filtros.tipo_movimiento] || filtros.tipo_movimiento}`);
        }
        if (filtros.id_usuario) filtrosAplicados.push(`Usuario: ${filtros.id_usuario}`);
        if (filtros.fecha) filtrosAplicados.push(`Fecha: ${filtros.fecha}`);
        ...
        doc.setFont('helvetica', 'bold');
        doc.setTextColor(...colorAzul);
        doc.text(`Total de movimientos: ${movimientos.length}`, 20, yPos);
        yPos += 8;
        ...
        const tableData = movimientos.map(movimiento => {
            ...
            const tipoTexto = tipoTextos[movimiento.tipo_movimiento] || movimiento.tipo_movimiento;

            return [
                fechaFormateada,
                movimiento.codigo_patrimonial || 'N/A',
                movimiento.marca || 'N/A',
                movimiento.modelo || 'N/A',
                movimiento.serie || 'N/A',
                tipoTexto,
                movimiento.usuario_responsable || 'N/A',
                movimiento.origen || 'N/A',
                movimiento.destino || 'N/A',
        ...
        if (tableData.length > 0) {
            doc.autoTable({
                startY: yPos,
                head: [['Fecha', 'Código Artículo', 'Marca', 'Modelo', 'Serie', 'Tipo Movimiento', 'Usuario Responsable', 'Origen', 'Destino', 'Motivo']],
                body: tableData,
                theme: 'striped',
                headStyles: {
                    fillColor: colorAzul,
        ...
        // Guardar PDF
        const nombreArchivo = `Historial_Cambios_${fecha.getFullYear()}${String(fecha.getMonth() + 1).padStart(2, '0')}${String(fecha.getDate()).padStart(2, '0')}_${String(fecha.getHours()).padStart(2, '0')}${String(fecha.getMinutes()).padStart(2, '0')}.pdf`;
        doc.save(nombreArchivo);
    } catch (error) {
...
async function cargarUsuariosFiltroHistorial() {
    ...
    try {
        const response = await fetch(getAppBasePath() + '/config/Movimientos.php', {
            ...
            body: JSON.stringify({
                action: 'obtener_usuarios_responsables'
            })
        });
...
async function marcarMovimientoRevisado(id_movimiento) {
    mostrarCardConfirmacion(
        '¿Marcar Movimiento como Revisado?',
        '¿Está seguro de que desea marcar este movimiento como revisado?<br><br>Esta acción indicará que el movimiento ha sido revisado.',
        async () => {
            try {
                const response = await fetch(getAppBasePath() + '/config/Movimientos.php', {
                    method: 'POST',
                ...
                if (result.success) {
                    mostrarCardEmergente(true, result.message || 'Movimiento marcado como revisado correctamente');
                    cargarMovimientos(); // Recargar la tabla
                } else {
                    mostrarCardEmergente(false, result.message || 'Error al marcar como revisado');
                }
            } catch (error) {
                console.error('Error al marcar movimiento como revisado:', error);
                mostrarCardEmergente(false, 'Error al marcar el movimiento como revisado. Por favor, intente nuevamente.');
            }
        },
        () => {
            // Cancelar - no hacer nada
...
// Mover item de inventario desde la tabla
async function moverItemInventarioDesdeTabla(id_inventario) {
    try {
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
        ...
        if (result.success && result.data) {
            ...
            if (!item.id_oficina && !item.id_seccion && !item.id_departamento && !item.id_direccion) {
                mostrarCardEmergente(false, 'Este item no está asignado a ningún espacio. Por favor, use la opción "Asignar A" para asignarlo.');
                return;
            }
            
            // Usar la función existente pero sin id_oficina_actual (puede ser null)
            mostrarModalMoverItem(id_inventario, item, item.id_oficina || null);
        } else {
            mostrarCardEmergente(false, result.message || 'Error al obtener datos del item');
        }
    } catch (error) {
...
async function cargarEspaciosAsignados() {
    ...
    try {
        ...
        // Solo mostrará espacios con asignación directa por oficina (ua.id_oficina = o.id_oficina)
        console.log('Buscando espacios asignados para usuario ID:', idUsuario);
        const response = await fetch(getAppBasePath() + '/config/Gestionespacios.php', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
        ...
        const result = await response.json();
        console.log('Resultado de espacios asignados:', result);
        
        loadingState.style.display = 'none';
        
        if (result.success && result.data && result.data.length > 0) {
            console.log('Espacios encontrados:', result.data.length);
            ...
            console.log('No se encontraron espacios asignados. Resultado:', result);
            emptyState.style.display = 'flex';
        }
    } catch (error) {
