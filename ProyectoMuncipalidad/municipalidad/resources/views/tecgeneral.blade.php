...
<head>
    ...
    <title>Técnico General - Municipalidad</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/tecgeneral.css') }}">
</head>
<body>
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <div class="user-role">Técnico General</div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/tecgeneral.js') }}"></script>
