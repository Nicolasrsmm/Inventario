...
<head>
    ...
    <title>Administrador - Municipalidad</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/administrador.css?18.1') }}">
</head>
<body>
    ...
    <div class="sidebar-menu-mobile" id="sidebarMenuMobile">
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-user-plus"></i> <span>Registrar Usuarios</span></a>
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-users"></i> <span>Gestionar Usuarios</span></a>
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-exclamation-triangle"></i> <span>Reportes de incidentes</span></a>
    ...
    <script src="{{ asset('js/administrador.js?18.1') }}"></script>
