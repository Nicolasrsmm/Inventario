...
<head>
    ...
    <title>Inventario - Municipalidad</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/inventario.css?30') }}">
</head>
<body>
    ...
    <div class="sidebar-menu-mobile" id="sidebarMenuMobile">
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-plus-circle"></i> <span>Registrar Espacios</span></a>
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-warehouse"></i> <span>Gestionar Espacios</span></a>
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-boxes"></i> <span>Inventario</span></a>
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-history"></i> <span>Cambios Realizados</span></a>
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-clock"></i> <span>Historial de Cambios</span></a>
    ...
    <script src="{{ asset('js/inventario.js?30') }}"></script>
