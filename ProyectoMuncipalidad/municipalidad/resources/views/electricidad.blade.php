...
<head>
    ...
    <title>Electricidad - Municipalidad</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/electricidad.css?18.1') }}">
</head>
<body>
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <div class="user-role">Electricidad</div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/electricidad.js?18.1') }}"></script>
