...
<head>
    ...
    <title>Informática - Municipalidad</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <link rel="stylesheet" href="{{ asset('css/informatica.css?19.1') }}">
</head>
<body>
    ...
    <div class="sidebar-menu-mobile" id="sidebarMenuMobile">
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-user-shield"></i> <span>Gestionar Equipamiento</span></a>
        ...
        <a href="#" class="menu-item" onclick="setActiveMenu(this)"><i class="fas fa-chart-bar"></i> <span>Reportes de incidentes</span></a>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="#" class="menu-item" onclick="setActiveMenu(this)">
                ...
                <span>Gestionar Equipamiento</span>
            </a>
            <a href="#" class="menu-item" onclick="setActiveMenu(this)">
        ...
        <div class="sidebar-footer">
            <div class="user-info">
                ...
                <div class="user-details">
                    ...
                    <div class="user-role">Informática</div>
                </div>
            </div>
    ...
    <script src="{{ asset('js/informatica.js?19.1') }}"></script>
